<div class="box-header with-border" style="border-bottom:1px solid #E6E4E4;padding-left:15px;background:#F5F4FD">
    <h1 class="box-title" style="font-size:150%;">Pengajuan Barang</h1>
</div>
<!-- Main content -->
  ...
  <div class="row">
        ...
        //  }?>
          <div style="width:28%;margin:5px 15px 0 5px ;padding:0 30px 0 0;overflow:hidden">
            <font size="4px" style="float:left;padding:10px;">Laporan Pengajuan Aset</font>
          </div>
    <div class="col-xs-12">
        ...
        <div class="box-body">
          <table id="example1" class="table table-bordered table-striped" style="font-size:100%">
            ...
            $no=1;
              ...
              $sql1=mysql_query("SELECT * FROM pesanan");
              ...
              ?><tr>
                  ...
                  <td><?php echo $bc1['jml_pesan']; ?></td>
                  <td><?php echo $bc1['tgl_pesan']; ?></td>
                  ...
                  <!--<td align="center">
                      ...
                      <a class="action" href="?menu=edit-pengajuan&kd=<?php echo $bc1['kd_pesan']; ?>" style="padding:2.3px 4px 2.3px 8px;" >
                        <i class="fa fa-edit" style="color:green;"> </i>Ubah
                      </a>
                      <a class="action" href="hapus_pengajuan.php?kd=<?php echo $bc1['kd_pesan'];?>" style="padding:2.3px 4px 2.3px 8px;" >
