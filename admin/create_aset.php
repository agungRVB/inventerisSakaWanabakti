 ...
 <div class="box box-primary" style="width:100%;margin:0 auto;">
	<div class="box-body"  style="width:99.5%">
      ...
      <tr><div class="form-group">
          ...
          <td><input type="text" class="form-control" name="nm_aset" placeholder="" required></td>
          </div>
      </tr>
      <tr><div class="form-group">
...
if (isset($_POST['submit'])) {
  include '../config/koneksi.php';
       ...
       mysql_query("INSERT INTO aset (kd_aset, nm_aset, jml_aset, jml_baik, jml_rusak, keterangan, stts) VALUES ('', '$nm_aset', '$jml_aset', '$jml_baik', '$jml_rusak', '$keterangan', '1')");
