...
<div class="box-header with-border" style="border-bottom:1px solid #E6E4E4;padding-left:15px;background:#F5F4FD">
  <h1 class="box-title" style="font-size:150%;">Aset Masuk</h1>
</div>
<section class="content-header">
  <font size="4px">Tambah Aset Masuk</font>
</section>
 ...
 <div class="box box-primary" style="width:100%;margin:0 auto;">
	<div class="box-body"  style="width:99.5%">
      ...
      <tr><div class="form-group">
          ...
          <td><input type="text" class="form-control" name="nama_aset" placeholder="" required></td>
          </div>
      </tr>
      <tr><div class="form-group">
          <td style="font-size:90%"><label for="exampleInputEmail1">Nomor Retur</label></td><td>:</td>
          <td><input type="text" class="form-control" name="nmr_retur" placeholder="" required></td>
          </div>
      </tr>
      <tr><div class="form-group">
          <td style="font-size:90%"><label for="exampleInputEmail1">Tanggal Masuk</label></td><td>:</td>
      ...
      <tr><div class="form-group">
          <td style="font-size:90%"><label for="exampleInputEmail1">Pengirim Aset</label></td><td>:</td>
