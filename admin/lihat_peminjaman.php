<div class="box-header with-border" style="border-bottom:1px solid #E6E4E4;padding-left:15px;background:#F5F4FD">
    <h1 class="box-title" style="font-size:150%;">Data Peminjaman Barang Belum Kembali</h1>
</div>
<!-- Main content -->
        ...
        <div class="box-body">
          <table id="example1" class="table table-bordered table-striped" style="font-size:100%">
            ...
            $no=1;
              ...
              $sql1=mysql_query("SELECT * FROM peminjaman WHERE stts_pinjam='Pinjam'");
              ...
              ?><tr>
                  ...
                  <td align="center">
                      ...
                      <a class="action" href="?menu=input-pengembalian&kd=<?php echo $bc1['kd_pinjam']; ?>" style="padding:2.3px 4px 2.3px 8px;" >
                        <i class="fa fa-edit" style="color:green;"> </i>Kembalikan Barang
                      </a>
