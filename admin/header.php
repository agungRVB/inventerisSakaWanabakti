      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar"><br/>
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="?menu=peminjaman"><i class="fa  fa-mail-forward" style="color:orange"></i> <span  style="color:orange">Peminjaman Aset</span></a></li>
            <li><a href="?menu=pengembalian"><i class="fa fa-mail-reply" style="color:orange"></i> <span style="color:orange">Pengembalian Aset</span></a></li>
            <li><a href="?menu=pengajuan"><i class="fa  fa-upload" style="color:orange"></i> <span style="color:orange">Pengajuan Aset</span></a></li>
