...
<section class="content">
  <div class="row">
          <a href="?menu=input-log" style="color:#595757;float:right;">
        ...
        //  }?>
          <div style="width:28%;margin:5px 15px 0 5px ;padding:0 30px 0 0;overflow:hidden">
            <font size="4px" style="float:left;padding:10px;">Data Log Kegiatan</font>
          </div>
    <div class="col-xs-12">
        ...
        <div class="box-body">
          <table id="example1" class="table table-bordered table-striped" style="font-size:100%">
            ...
            $no=1;
              ...
              $sql1=mysql_query("select * from log_book");
              while ($bc1=mysql_fetch_array($sql1)){
              ?><tr>
                  <td align="center"><?php echo $no; $no++;;?></td>
                  <td><?php echo $bc1['kegiatan']; ?></td>
                  <td><?php echo $bc1['tgl_kegiatan']; ?></td>
                  <td><?php echo $bc1['deskripsi_kegiatan']; ?></td>
                  <td align="center">
                      <a class="action" href="?menu=edit-log&kd=<?php echo $bc1['kd_kegitan']; ?>" style="padding:2.3px 4px 2.3px 8px;" >
                        <i class="fa fa-edit" style="color:green;"> </i>Ubah
                      </a>
                      <a class="action" href="hapus_log.php?kd=<?php echo $bc1['kd_kegitan'];?>" style="padding:2.3px 4px 2.3px 8px;" >
