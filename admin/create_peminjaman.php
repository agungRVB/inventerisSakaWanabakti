...
<section class="content-header">
  <font size="4px">Tambah Peminjaman Aset</font>
</section>
 ...
 <div class="box box-primary" style="width:100%;margin:0 auto;">
	<div class="box-body"  style="width:99.5%">
      ...
      <tr><div class="form-group">
          ...
          <td><input type="text" class="form-control" name="nm_peminjam" placeholder="" required></td>
          </div>
      </tr>
      <tr>
              ...
              <select name="kd_aset"  class="form-control select2" required style="width:100%;">
                <option value="0"> -Pilih Barang-</option>
                  ...
                  <?php
                      ...
                      $sql2 = mysql_query("SELECT * FROM aset WHERE stts=1");
      ...
      <tr><div class="form-group">
          ...
          <td><div class="input-group">
            ...
            <input type="text" name="tgl_pinjam" class="form-control" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask>
          </div></td>
          </div>
      </tr>
...
if (isset($_POST['submit'])) {
       ...
       mysql_query("INSERT INTO peminjaman (kd_pinjam, kd_aset, nm_peminjam,jml_baik, jml_rusak, tgl_pinjam, keterangan) VALUES ('', '$kd_aset', '$nm_peminjam', '$jml_baik', '$jml_rusak', '$tgl_pinjam', '$keterangan');");
