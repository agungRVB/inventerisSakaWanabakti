        ...
        <section class="content">
          <div class="row">
                  <a href="?menu=input-keluar" style="color:#595757;float:right;">
                ...
                //  }?>
                  <div style="width:28%;margin:5px 15px 0 5px ;padding:0 30px 0 0;overflow:hidden">
                    <font size="4px" style="float:left;padding:10px;">Data Surat Keluar</font>
                  </div>
            <div class="col-xs-12">
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped" style="font-size:100%">
                    ...
                    $no=1;
                      ...
                      $sql1=mysql_query("select * from surat where jenis_surat='2'");
                      ...
                      ?><tr>
                          ...
                          <td align="center">
                            <a class="action" href="<?php echo $bc1['bukti_surat']; ?>" style="padding:2.3px 4px 2.3px 8px;" >
                              ...
                              <a class="action" href="?menu=edit-keluar&kd=<?php echo $bc1['kd_surat']; ?>" style="padding:2.3px 4px 2.3px 8px;" >
