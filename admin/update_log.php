<?php
   ...
   $sql=mysql_query("SELECT * FROM log_book WHERE kd_kegitan='$_GET[kd]'");
 ...
 <div class="box box-primary" style="width:100%;margin:0 auto;">
	<div class="box-body"  style="width:99.5%">
      ...
      <tr><div class="form-group">
          ...
          <td><input type="text" class="form-control" name="kegiatan" value="<?php echo $bc['kegiatan']; ?>" placeholder="" required></td>
          </div>
      </tr>
      <tr><div class="form-group">
          ...
          <td><div class="input-group">
            ...
            <input type="text" value="<?php echo $bc['tgl_kegiatan']; ?>" name="tgl_kegiatan" class="form-control" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask>
          </div></td>
          </div>
      </tr>
      ...
      <tr><div class="form-group">
          ...
          <td><textarea class="textarea" name="deskripsi_kegiatan" placeholder="" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">
              <?php echo $bc['deskripsi_kegiatan']; ?>
          </textarea></td>
          </div>
      </tr>
      <tr>
...
if (isset($_POST['submit'])) {
  include '../config/koneksi.php';
       mysql_query("UPDATE log_book SET kegiatan = '$kegiatan', tgl_kegiatan = '$tgl_kegiatan', deskripsi_kegiatan = '$deskripsi_kegiatan' WHERE kd_kegitan = '$_GET[kd]'");
}
 ?>
