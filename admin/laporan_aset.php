<div class="box-header with-border" style="border-bottom:1px solid #E6E4E4;padding-left:15px;background:#F5F4FD">
    <h1 class="box-title" style="font-size:150%;">Data Aset</h1>
</div>
<!-- Main content -->
5

        <a href="print_aset.php" style="color:#595757;float:right;">
        ...
        //  }?>
          <div style="width:28%;margin:5px 15px 0 5px ;padding:0 30px 0 0;overflow:hidden">
            <font size="4px" style="float:left;padding:10px;">Laporan Aset </font>
          </div>
    <div class="col-xs-12">
        ...
        <div class="box-body">
          <table id="example1" class="table table-bordered table-striped" style="font-size:100%">
            ...
            $no=1;
              ...
              $sql1=mysql_query("SELECT * FROM aset WHERE stts='1'");
              while ($bc1=mysql_fetch_array($sql1)){
              ?><tr>
                  <td align="center"><?php echo $no; $no++;;?></td>
                  <td><?php echo $bc1['nm_aset']; ?></td>
                  <td><?php echo $bc1['jml_aset']; ?></td>
                  ...
                  <!--<td align="center">
                      ...
                      <a class="action" href="?menu=edit-aset&kd=<?php echo $bc1['kd_aset']; ?>" style="padding:2.3px 4px 2.3px 8px;" >
                        <i class="fa fa-edit" style="color:green;"> </i>Ubah
                      </a>
                      <a class="action" href="hapus_aset.php?kd=<?php echo $bc1['kd_aset'];?>" style="padding:2.3px 4px 2.3px 8px;" >
