 ...
 <div class="box box-primary" style="width:100%;margin:0 auto;">
	<div class="box-body"  style="width:99.5%">
      ...
      <tr><div class="form-group">
          ...
          <td><input type="text" class="form-control" value="<?php echo $bc1['jml_pesan'];?>" name="jml_pesan" placeholder="" required></td>
          </div>
      </tr>
      <!--<tr><div class="form-group">
...
if (isset($_POST['submit'])) {
       ...
       mysql_query("UPDATE pesanan SET kd_aset='$kd_aset', jml_pesan='$jml_pesan', tgl_pesan='$tgl_pesan', keterangan='$keterangan' WHERE kd_pesan='$_GET[kd]'");
