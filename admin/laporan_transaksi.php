...
<section class="content">
  <div class="row">
    <section class="content">
      <div class="row">
        <a href="print_transaksi.php" style="color:#595757;float:right;">
...
<section class="content">
  <div class="row">
          <a href="?menu=lihat-peminjaman" style="color:#595757;float:right;">
          <div class="tab-pane" id="glyphicons">
            <ul class="bs-glyphicons">
              <li>
        ...
        //  }?>
          <div style="width:28%;margin:5px 15px 0 5px ;padding:0 30px 0 0;overflow:hidden">
            <font size="4px" style="float:left;padding:10px;">Data Pengembalian Aset</font>
          </div>
    <div class="col-xs-12">
        ...
        <div class="box-body">
          <table id="example1" class="table table-bordered table-striped" style="font-size:100%">
            ...
            $no=1;
              ...
              $sql1=mysql_query("SELECT * FROM transaksi");
