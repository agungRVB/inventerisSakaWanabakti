...
<html>
  <head>
    ...
    <title>.::Inventaris Saka Wanabanti Kota Semarang::.</title>
    ...
    <div class="wrapper">
      <header class="main-header">
        ...
        <a class="logo">
          ...
          <span class="logo-lg"><b>SAKA WANABAKTI</b></span>
        </a>
        ...
        <section class="sidebar"><br/>
          ...
          <div class="user-panel">
            <div class="pull-left image">
              <img src="../images/saka-wanabakti.png" class="img-circle" alt="User Image">
            </div>
            <div class="pull-left info">
              <pixels>Salam... <br> Kak Suplier <?php// echo $nama;?></p>
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="?menu=aset"><i class="fa fa-suitcase" style="color:orange"></i> <span  style="color:orange">Data Aset</span></a></li>
            <li><a href="?menu=peminjaman"><i class="fa  fa-mail-forward" style="color:orange"></i> <span  style="color:orange">Peminjaman Barang</span></a></li>
            <li><a href="?menu=pengembalian"><i class="fa fa-mail-reply" style="color:orange"></i> <span style="color:orange">Pengembalian Barang</span></a></li>
            <li><a href="?menu=pengajuan"><i class="fa  fa-upload" style="color:orange"></i> <span style="color:orange">Pengajuan Barang</span></a></li>
            <li><a href="?menu=user"><i class="fa fa-user-plus" style="color:orange"></i> <span  style="color:orange">Kelola User</span></a></li>
            <li><a href="?menu=laporan-aset"><i class="fa fa-book" style="color:orange"></i> <span  style="color:orange">Laporan Aset</span></a></li>
            <li><a href="?menu=laporan-peminjaman"><i class="fa fa-book" style="color:orange"></i> <span  style="color:orange">Laporan Peminjaman</span></a></li>
            <li><a href="?menu=laporan-pengembalian"><i class="fa fa-book" style="color:orange"></i> <span  style="color:orange">Laporan Pengembalian</span></a></li>
            <li><a href="?menu=laporan-pengajuan"><i class="fa fa-book" style="color:orange"></i> <span  style="color:orange">Laporan Pengajuan</span></a></li>
          ...
          <li><a href="?menu=pengajuan"><i class="fa  fa-upload" style="color:orange"></i> <span style="color:orange">Pengajuan Barang</span></a></li>
          <li><a href="?menu=pengajuan-acc"><i class="fa  fa-upload" style="color:orange"></i> <span style="color:orange">Pengajuan Barang Acc</span></a></li>
