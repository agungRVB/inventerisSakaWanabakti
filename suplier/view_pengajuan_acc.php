        ...
        <div class="box-body">
          <table id="example1" class="table table-bordered table-striped" style="font-size:100%">
            ...
            $no=1;
              ...
              $sql1=mysql_query("SELECT * FROM pesanan WHERE stts_pesan='2'");
              ...
              ?><tr>
                  ...
                  <td align="center">
                      ...
                      <a class="action" href="update_pengajuan.php?kd=<?php echo $bc1['kd_pesan']; ?>" style="padding:2.3px 4px 2.3px 8px;" >
                        <i class="fa fa-edit" style="color:green;"> </i>Batal Acc Pengajuan
                      </a>
                  </td>
                </tr>
              <?php
